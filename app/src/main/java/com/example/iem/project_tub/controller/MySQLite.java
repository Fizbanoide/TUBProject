...
public class MySQLite extends SQLiteOpenHelper {
    ...
    private MySQLite(Context context) {
        ...
        String filesDir = context.getFilesDir().getPath(); // /data/data/com.example.iem.project_tub/files
        DATABASE_PATH = filesDir.substring(0, filesDir.lastIndexOf("/")) + "/databases/"; // /data/data/com.example.iem.project_tub/databases/
